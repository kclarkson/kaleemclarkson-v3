  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        ...
        <title>Sitemap - Kaleem Clarkson</title>
        <style type="text/css">
          html {
            margin: 0;
            padding: 0;
      ...
      <body>
        <h1>List of URLs for <a href="https://www.kaleemclarkson.com/">Kaleem Clarkson</a>:</h1>
        <form>
          ...
          <input id="feed-url" onClick="this.select();">
            ...
            <xsl:attribute name="value">https://www.kaleemclarkson.com/sitemap.xml</xsl:attribute>
          </input>
        </form>
        <ol>
